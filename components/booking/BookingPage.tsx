...
export default function BookingPage() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 pt-10 pb-5 md:pt-32 md:pb-20">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 bg-gradient-to-r from-primary-700 via-primary-600 to-purple-700 bg-clip-text text-transparent leading-tight">
            ...
            {/* <div className="flex flex-wrap justify-center gap-4">
              <div className="flex items-center space-x-2 px-4 py-2 bg-white rounded-full shadow-sm">
                ...
                <span className="text-sm font-medium text-gray-700">Personal Sessions</span>
              </div>
              <div className="flex items-center space-x-2 px-4 py-2 bg-white rounded-full shadow-sm">
